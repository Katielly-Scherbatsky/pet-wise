<template>
  ...
  <div style="margin-bottom: 100px">
    <v-row>
      <v-col cols="12" style="margin-top: 60px; margin-left: 190px">
        <h1 class="text-left" style="color: #04131a">
          Vacinas e anti-pulgas<span style="color: #00bfae">.</span>
          <v-btn
            style="background-color: #cdccd2; margin-left: 168px; height: 45px"
            @click="openModal()"
          >
    ...
    <div class="d-flex flex-wrap" style="margin-left: 150px">
      <card-vacinas></card-vacinas>
    </div>
  </div>
  <div>
    <modal-vacina-antipulgas
      :isOpen="modalOpen"
      title="Cadastar Vacina/Anti-Pulgas"
      @save="handleSave"
...
import ModalVacinaAntipulgas from "@/components/ModalInserir.vue";
export default {
  components: { CardVacinas, ModalVacinaAntipulgas, FieldComponentInserir },
  name: "PaginaInicial",
  data() {
    return {
      modalOpen: false,
