    ...
    <v-row>
      <v-col cols="12" style="margin-top: 60px; margin-left: 190px">
        <h1 class="text-left" style="color: #04131a">
          Controle de peso<span style="color: #00bfae">.</span>
          <v-btn
            style="background-color: #cdccd2; margin-left: 315px; height: 45px"
            @click="openModal()"
          >
...
import ModalControlePeso from "@/components/ModalInserir.vue";
export default {
  components: {
    ButtonComponent,
    CardPeso,
